...
lastmod: 2026-02-24T21:27:49+01:00
draft: false
---
...
## Mac OSX Settings {#mac-osx-settings}
...
### Global Tab settings {#global-tab-settings}
...
### Parenthesis Handling {#parenthesis-handling}
...
#### Create matching parenthesis {#create-matching-parenthesis}
...
### Babel Tangle Config {#babel-tangle-config}
...
This code snippet adds an additional function to the `project-find-functions` which searches for a _.project_ file in the root of the chosen directory. If it is present, the directory is seen as a project by project.el
