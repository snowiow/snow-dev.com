...
information like the username and the URL of where the password belongs to. This
...
for another functionality, you can show the pass man pages via:
...
Since Mac OSX and Linux both build onto Unix, the process is pretty
...
<img src="/images/openkeychain.png" alt="openkeychain welcome screen"
title="openkeychain welcome screen" />

Select _OPEN KEY FROM FILE_ and click on the directory symbol on the newly
opened dialogue to select the gpg key file:

<img src="/images/openkeychain2.png" alt="openkeychain import key"
title="openkeychain import key" />

Now your GPG key is also setup on your phone. Next we install the _Password
Store_ app and open it:

<img src="/images/password-store1.png" alt="password-store opening screen"
